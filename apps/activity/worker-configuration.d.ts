/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4aee008fc14972f02b1ab92b93397780)
// Runtime types generated with workerd@1.20260722.1 2026-07-25 
interface __BaseEnv_Env {
	DB: D1Database;
	MATCH_RESULTS_QUEUE: Queue;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production" | "local";
	ALLOW_LOCAL_AUTH: "false" | "true";
	DISCORD_CLIENT_ID: "REPLACE_WITH_STAGING_DISCORD_CLIENT_ID" | "REPLACE_WITH_PRODUCTION_DISCORD_CLIENT_ID" | "local-discord-client";
	GAME_ROOMS: DurableObjectNamespace<import("./src/worker/index").GameRoom>;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		APP_ENV: "production";
		ALLOW_LOCAL_AUTH: "false";
		DISCORD_CLIENT_ID: "REPLACE_WITH_PRODUCTION_DISCORD_CLIENT_ID";
		GAME_ROOMS: DurableObjectNamespace<import("./src/worker/index").GameRoom>;
	}
